...
if '-h' in sys.argv or '--help' in sys.argv:
    ...
    print("It works similar to 'git bisect', and will repeatedly ask the user to mark dependency sets ad good or bad,")
    print("splitting the search space based on the results.")
    print()
    print("To run it you need to provide:")
    print("    1. A pip requirements file where the dependencies that might have caused the regression are pinned to known good versions.")
